...
add_action('rest_api_init', function() {
    ...
    register_rest_route('qounam/v1', '/tailored-course/request', array(
        'methods' => 'POST',
...
function submit_tailored_course_request($request) {
    ...
    $message = "A new tailored course request has been submitted:<br><br>";
    ...
    $message .= "Company: " . $request->get_param('company') . "<br>";
    $message .= "Phone Number: " . $request->get_param('phone_number') . "<br>";
    $message .= "Government: " . $request->get_param('government') . "<br>";
    $message .= "Position: " . $request->get_param('position') . "<br>";
    $message .= "Course Objectives: " . $request->get_param('course_objectives') . "<br><br>";
